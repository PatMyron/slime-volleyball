...
int main()
{
    ...
    Person_type player1={" ",wd/4,ht,vx,vy,radius,{0,wd/2}, onground,lives,{0,255,0},wins, p1}, *pPlayer1;
    Person_type player2={" ",3*wd/4,ht,vx,vy,radius,{wd/2,wd}, onground,lives,{0,0,255},wins, p2}, *pPlayer2;
...
Person_type * playerExists(Person_type *p,Person_type *new ){
...
void drawPlayerKeysAtStartScreen(){
    ...
    gfx_rectangle(wd/2-300+50, ht/2+150,40,40); // strange error where this one doesnt draw first function call
    ...
    gfx_triangle(wd/2+200+50 +20, ht/2+150 +5,wd/2+200+50 +20-5, ht/2+150 +5+5,wd/2+200+50 +20+5, ht/2+150 +5+5);
    gfx_line(wd/2+200 +20+15, ht/2+200 +20,wd/2+200 +20-15, ht/2+200 +20);
    gfx_triangle(wd/2+200 +20-15, ht/2+200 +20,wd/2+200 +20-15+5, ht/2+200 +20+5,wd/2+200 +20-15+5, ht/2+200 +20-5);
    gfx_line(wd/2+200+100 +20+15, ht/2+200 +20,wd/2+200+100 +20-15, ht/2+200 +20);
    gfx_triangle(wd/2+200+100 +20+15, ht/2+200 +20,wd/2+200+100 +20+15-5, ht/2+200 +20+5,wd/2+200+100 +20+15-5, ht/2+200 +20-5);
}
